export const EXPERIENCE = [
  {
    ...
    firm: "The Advisory Investment Bank",
  ...
  {
    id: "aa",
    role: "Airport Operations Intern",
  ...
  {
    id: "eyp",
    role: "Transaction and Strategy Intern",
    firm: "EY-Parthenon",
  ...
  {
    id: "ey",
    role: "Transaction Due Diligence Intern",
    firm: "EY",
...
export const EDUCATION = [
  {
    ...
    degree: "B.S. Finance & B.S. Business Analytics",
    dates: "Expected May 2027",
    place: "West Lafayette, IN",
    note: "Mitchell E. Daniels, Jr. School of Business",
  },
];

export const CERTS = [
  "CRE Fundamentals I · Destined",
  "Entry-level Python · Purdue",
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    meta: "Python · Pandas · Matplotlib · Seaborn",
    blurb:
  ...
  {
    id: "deposits",
    title: "Bank Deposits and Interest Rates",
    meta: "SQL · Data warehouse",
    blurb:
  ...
  {
    id: "sales",
    title: "Sales Insights and Profitability",
    meta: "R · RStudio · MGMT 173",
    blurb:
  ...
  {
    id: "housing",
    title: "Sustainable Purdue Housing",
    meta: "Top 10 · CYC · TJNAN",
    blurb:
